...
User.create({username: 'pilot', email: 'a@test.com', password: '123456', password_confirmation: '123456', role_id: 1})
User.create({username: 'admin', email: 'test@test.com', password: '123456', password_confirmation: '123456', role_id: 2})
